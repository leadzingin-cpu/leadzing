...
// A stalled connection (e.g. flaky wifi) would otherwise leave `fetch` pending
// indefinitely — the button would stay stuck on "Booking..." forever with no
// way for the user to know something's wrong. This bounds every request to a
// reasonable ceiling so it always resolves one way or the other.
